...
class User_Inserts {
    static void userInserts(Connection connection) {
        try(Statement statement = connection.createStatement()) {
            ...
            statement.executeUpdate("INSERT INTO `kurmaz`.`Address` (`ID`, `Country`, `City`, `Street`, `Building`, `Apt`, `ZIP`) VALUES (DEFAULT, 'Belarus', 'Minsk', 'Nezavisimosti', '10', '2', '2200099');");
            statement.executeUpdate("INSERT INTO `kurmaz`.`Address` (`ID`, `Country`, `City`, `Street`, `Building`, `Apt`, `ZIP`) VALUES (DEFAULT, 'Belarus', 'Gomel', 'Minskaya', '2', '5', '2230909');");
            statement.executeUpdate("INSERT INTO `kurmaz`.`Address` (`ID`, `Country`, `City`, `Street`, `Building`, `Apt`, `ZIP`) VALUES (DEFAULT, 'Belarus', 'Brest', 'Brestskaya', '105', '310', '2290909');");
            statement.executeUpdate("INSERT INTO `kurmaz`.`Address` (`ID`, `Country`, `City`, `Street`, `Building`, `Apt`, `ZIP`) VALUES (DEFAULT, 'Italy', 'Rome', 'Unknown', '1', '1', '3333333');");
